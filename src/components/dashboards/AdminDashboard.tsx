...
export const AdminDashboard: React.FC = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      // Calculate new products (last 30 days)
      ...
      // Get consumption type stats from clients
      ...
      // Calculate rep visit statistics
          ...
          <div className="mt-5 space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-300">New rep John Smith was added to the system</p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-300">5 new products added to inventory</p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-300">Weekly sales report generated</p>
  ...
  const renderRepsTab = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 shadow rounded-lg border border-gray-700">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-white mb-4">Invite New User</h3>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setInviteForm({ ...inviteForm, role: e.target.value as 'Rep' | 'Admin' })}
      ...
      <div className="bg-gray-800 shadow rounded-lg border border-gray-700">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-white mb-4">All Users</h3>
  ...
  const renderBulkUploadTab = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 shadow rounded-lg border border-gray-700">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-white mb-4">Add Single Product</h3>
          <form onSubmit={handleAddProduct} className="space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Input
                label="Product Name"
      ...
      <div className="bg-gray-800 shadow rounded-lg border border-gray-700">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-lg leading-6 font-medium text-white mb-4">Bulk Upload Products & Clients</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Excel File</label>
              <p className="text-sm text-gray-400 mb-2">
                {uploadType === 'Products' 
                  ? 'Excel should have columns: name, description, price' 
                  : 'Excel should have columns: name, email, phone, address, consumption_type, call_frequency, assigned_rep_id'
                }
              </p>
              <input
                type="file"
            ...
            <div className="mt-6 p-4 bg-gray-700 rounded-lg">
              ...
              <div className="space-y-2">
                <p className="text-green-400">
                  ...
                  Successfully processed: {uploadResults.success}/{uploadResults.total}
                </p>
    ...
    <div className="space-y-6">
      ...
      {reportStats && (
        <>
          {/* Key Metrics */}
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div className="bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-700 p-5">
              <div className="flex items-center">
                <Users className="h-8 w-8 text-blue-400" />
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-400">Total Clients</p>
                  <p className="text-2xl font-semibold text-white">{reportStats.totalClients}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-700 p-5">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-white">{reportStats.totalProducts}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-700 p-5">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-400">New Products (30d)</p>
                  <p className="text-2xl font-semibold text-white">{reportStats.newProducts}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-700 p-5">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-400">Visits Today</p>
                  <p className="text-2xl font-semibold text-white">{reportStats.visitsToday}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="bg-gray-800 shadow rounded-lg border border-gray-700 p-6">
              <h3 className="text-lg font-medium text-white mb-4">Visit Statistics</h3>
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-gray-300">This Week</span>
                  <span className="text-white font-semibold">{reportStats.visitsWeek}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">This Month</span>
                  <span className="text-white font-semibold">{reportStats.visitsMonth}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">On-Consumption Clients</span>
                  <span className="text-white font-semibold">{reportStats.onConsumptionVisits}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Off-Consumption Clients</span>
                  <span className="text-white font-semibold">{reportStats.offConsumptionVisits}</span>
                </div>
              </div>
            </div>
            ...
            {/* Rep Performance */}
            <div className="bg-gray-800 shadow rounded-lg border border-gray-700 p-6">
              <h3 className="text-lg font-medium text-white mb-4">Rep Performance</h3>
              <div className="space-y-3">
                {reportStats.repVisitStats.slice(0, 5).map((rep) => (
                  <div key={rep.rep_id} className="flex justify-between items-center">
                    <div>
                      <p className="text-white font-medium">{rep.rep_name}</p>
                      <p className="text-sm text-gray-400">{rep.total_visits} visits</p>
                    </div>
                    <div className="text-right">
                      <p className="text-purple-400 font-semibold">{rep.avg_duration_minutes}m</p>
