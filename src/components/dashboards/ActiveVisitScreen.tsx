...
export const ActiveVisitScreen: React.FC<ActiveVisitScreenProps> = ({
  ...
  // Effect to save order items to localStorage whenever they change
  useEffect(() => {
  ...
  const updateQuantity = (product: Product, quantity: number) => {
    setOrderItems(prev => {
        ...
        const orderItem: OrderItem = { product_id: product.id, product_name: product.name, price: product.price, quantity, total: product.price * quantity };
